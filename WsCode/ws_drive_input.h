...
#define CRAB_PAST_90_DEG        30
#define CRAB_LEFT_LIMIT         (-90 - (CRAB_PAST_90_DEG))
#define CRAB_RIGHT_LIMIT        (90 + (CRAB_PAST_90_DEG))
...
extern UINT8 get_crab_pot_tgt(INT8, CrabType *);
