...
void crab_init()
{
  ...
  g_crab_back_pid_vals.prop_gain = 4 * g_crab_back_pid_vals.scale_factor;
  g_crab_back_pid_vals.int_gain = 12;
...
void crab_stick_input()
{
  ...
  if (car_drive == FALSE)
  {
    ...
    else
    {
      ...
      /*
      printf("crab: pos %d ", crab_desired_pos_deg);
      */
...
* PURPOSE:
*******************************************************************************/
UINT8 get_crab_pot_tgt(INT8 desired_pos_in_deg, CrabType *calibration)
{
  INT16 desired_crab_pos_pot;
  ...
  MIN_MAX(desired_crab_pos_pot, 0, 254);
